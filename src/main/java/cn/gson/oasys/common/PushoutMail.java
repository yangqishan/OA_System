...
public class PushoutMail {
	...
	public static String myEmailAccount = "2912897158@qq.com";
    public static String myEmailPassword = "wili1314";
 ...
 // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "18770841263@163.com";
