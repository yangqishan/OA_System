...
public class Attends {
	...
	@Column(name = "attends_hostname")
	private String attendsHostname; //登录电脑名
	...
	public String getAttendsHostname() {
		return attendsHostname;
	}

	public void setAttendsHostname(String attendsHostname) {
		this.attendsHostname = attendsHostname;
	}
	...
	public Attends(Long typeId, Long statusId, Date attendsTime, String attendsIp, String attendsHostname, String attendsRemark, User user) {
		super();
		this.typeId = typeId;
		this.statusId = statusId;
		this.attendsTime = attendsTime;
	...
	public Attends(Long typeId, Long statusId, Date attendsTime, String attendHmtime, String weekOfday,
			String attendsIp,String attendsHostname, User user) {
		super();
		this.typeId = typeId;
		this.statusId = statusId;
		this.attendsTime = attendsTime;
	...
	public String toString() {
		return "Attends [attendsId=" + attendsId +
				", typeId=" + typeId +
				", statusId=" + statusId +
				...
				", weekOfday=" + weekOfday +
				", attendsIp=" + attendsIp +
				", attendsHostname" + attendsHostname +
